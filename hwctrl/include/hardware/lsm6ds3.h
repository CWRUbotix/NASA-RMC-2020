...
constexpr double gyro_var = (double)(degrees_to_radians(g_rms_noise) * degrees_to_radians(g_rms_noise));
constexpr double xl_var   = (double)(xl_rms_noise * xl_fs) * (xl_rms_noise * xl_fs);
...
private:
	...
	VarianceMatrix m_cov_xl = {xl_var, 0.0, 0.0,
								0.0, xl_var, 0.0,
								0.0, 0.0, xl_var};
	VarianceMatrix m_cov_g  = {gyro_var, 0.0, 0.0,
								0.0, gyro_var, 0.0,
								0.0, 0.0, gyro_var};
};
