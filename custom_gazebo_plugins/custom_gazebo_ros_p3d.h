...
namespace gazebo
{
  class CustomGazeboRosP3D : public ModelPlugin
  {
    /// \brief Constructor
    public: CustomGazeboRosP3D();

    /// \brief Destructor
    public: virtual ~CustomGazeboRosP3D();
    ...
    private: PubQueue<geometry_msgs::PoseWithCovarianceStamped>::Ptr pub_Queue;

    /// \brief ros message
    private: geometry_msgs::PoseWithCovarianceStamped pose_msg_;
